...
{
 public class TilesGameFactory
 {
  private readonly DiContext _diContext;

  public TilesGameFactory(DiContext diContext)
  {
   _diContext = diContext;
  }

  public TilesGame BuildLevel(LevelConfig levelConfig)
  {
   ...
   return new TilesGame(solvableItems);
